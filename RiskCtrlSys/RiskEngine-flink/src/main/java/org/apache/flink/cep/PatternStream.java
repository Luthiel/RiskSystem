...
public class PatternStream<T> {
    ...
    PatternStream(final DataStream<T> inputStream, final DynamicPattern<T> dynamicPattern) {
        this(PatternStreamBuilder.luthielForStreamAndPattern(inputStream, dynamicPattern));
    }
    ...
    public PatternStream<T> inProcessingTimeLuthiel() {
        return new PatternStream<>(builder.inProcessingTimeLuthiel());
    }
    ...
    public PatternStream<T> inEventTimeLuthiel() {
        return new PatternStream<>(builder.inEventTimeLuthiel());
    }
