...
import com.luthiel.RiskCtrlSys.flink.job.map.KafkaETL;
import com.luthiel.RiskCtrlSys.flink.kafka.LuthielDeserializationSchema;
...
public class KafkaUtil {
    ...
    private static void kafkaSourceBuilder() {
        ...
        KAFKA_SOURCE = KafkaSource.<KafkaMessagePO>builder()
                 ...
                 *
                 * *********************/
                .setDeserializer(KafkaRecordDeserializationSchema.of(new LuthielDeserializationSchema()))
