package com.luthiel.RiskCtrlSys.flink.job.aggregation;

import com.luthiel.RiskCtrlSys.flink.job.aggregation.acc.AccAggregate;
import com.luthiel.RiskCtrlSys.flink.job.aggregation.acc.AccAggregateFactory;
...
public class MetricAggFunction implements
    ...
    public Tuple3<EventPO, Double,Integer> add(EventPO eventPO, Tuple3<EventPO, Double,Integer> accumulator) {
        ...
        //获取指标计算配置中的累加器计算方法（第一种是 +1，第二种是时间间隔累加）
