package com.luthiel.RiskCtrlSys.commons.constants;
...
public class ConstantsUtil {
     ...
     * 包路径
     */
    public static final String PACKAGE_DIR = "com/luthiel/RiskCtrlSys";
     ...
     * 父包路径
     */
    public static final String PARENT_PACKAGE = "com.luthiel.RiskCtrlSys";
     ...
     * 数据库url
     */
    public static final String MYSQL_URL = "jdbc:mysql://mysql:3306/luthiel?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&useSSL=false"
    ;
    /**
     * 数据库用户名
     */
     ...
     * 作者
     */
    public static final String AUTHOR = "luthiel";
    /**
     * 日期格式
     */
     ...
     */
    public static final String PATH_CLASS_METRIC_REDIS_FUNCTION = "com.luthiel.RiskCtrlSys.flink.job.aviator.MetricRedisFunction";
